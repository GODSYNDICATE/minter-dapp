...
const welcome_h1 = "Welcome to the GODSYNDICATE NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'GODSYNDICATE NFT Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection. Follow step by step on the <a href="https://youtube.com/codestackr"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
